...
export const VirusDangersInformation = () => {
    ...
    const scaleText = useTransform(scrollYProgress, [0.00, .3], [.8, 1])
    const opacityText = useTransform(scrollYProgress, [0.00, .3], [0, 1])
    ...
    return (
        <>
        <motion.div className={styles.virusDangersContainer} ref={ref} >
